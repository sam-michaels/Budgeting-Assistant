    ...
    public partial class InitialSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MerchantExamples", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MerchantExamples_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RawDescription = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
                    NormalizedMerchant = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
                    Embedding = table.Column<Vector>(type: "vector(384)", nullable: true),
                    CategorySource = table.Column<int>(type: "integer", nullable: false),
                    CategoryConfidence = table.Column<float>(type: "real", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_Transactions_DuplicateOfId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MerchantExamples_CategoryId",
                table: "MerchantExamples",
                column: "CategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_DuplicateOfId",
                table: "Transactions",
